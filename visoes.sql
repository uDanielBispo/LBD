...
SELECT CODMEDICO, CODPACIENTE, DATACONSULTA+30 AS RETORNO
FROM CONSULTA;
...
SELECT NOMMEDICO, CODCONSULTA, DATACONSULTA 
...
SELECT CODMEDICO, SUM(VALCONSULTA) AS TOTAL
FROM CONSULTA
GROUP BY CODMEDICO;
...
SELECT C.CODMEDICO, M.NOMMEDICO, AVG(C.VALCONSULTA) AS MEDIA
